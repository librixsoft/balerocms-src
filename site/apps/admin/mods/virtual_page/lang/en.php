...
define("_VIRTUAL_PAGE", "Virtual page");
define("_NEW_VIRTUAL_PAGE", "Create new virtual page");
define("_ENABLED_CONTENT", "Enabled content");
define("_DISABLED_CONTENT", "Disabled content");

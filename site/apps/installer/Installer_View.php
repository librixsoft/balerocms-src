...
class installer_View
{
    ...
    private string $check_icon = "<img src=\"site/apps/installer/html/images/check-icon.png\">";
    ...
    public function wizard()
    {
        ...
        try {
            ...
            if (empty($this->configSettings->getBasepath())) {
                $basepath = $this->configSettings->FullBasepath();
            } else {
                $basepath = $this->configSettings->getBasepath();
            }
            ...
            if (empty($this->configSettings->getUser()) || empty($this->configSettings->getPass()) || empty($this->configSettings->getFirstname()) || empty($this->configSettings->getLastname()) || empty($this->configSettings->getEmail())) {
                $this->check_admin = "";
            }

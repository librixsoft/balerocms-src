...
class ErrorConsole
{
    ...
    private static function renderConsole($mainMessage, Throwable $e = null)
    {
        ...
        echo '<style>
            ...
            .console-icon {
                border: 3px solid #bbb; /* borde más grueso y color gris intermedio */
                padding: 2px 8px;
                font-weight: 700;
                color: #bbb; /* gris intermedio */
                font-family: monospace;
                user-select: none;
                display: flex;
                align-items: center;
                justify-content: center;
                font-size: 16px; /* tamaño un poco más pequeño */
                border-radius: 8px; /* más redondeado */
                flex-shrink: 0;
                height: 22px; /* altura ajustada */
            }
            .console-title {
                color: #33ff33;
                font-weight: 600;
